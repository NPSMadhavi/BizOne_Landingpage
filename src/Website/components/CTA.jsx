...
export default function CTASection() {
  return (
    <section id="contact" className="py-16 responsive-container">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#EAF4FF] via-[#F4F8FF] to-[#E5F4FF] px-6 py-10 text-center sm:px-12 lg:px-20"
        >
          {/* Decorative Blur */}
          ...
          {/* Heading */}
          <h2 className="mx-auto max-w-3xl text-fluid-lg font-medium leading-tight text-[#101828]">
            Ready to Simplify Your Business Operations?
          </h2>

          {/* Description */}
          <p className="mx-auto mt-6 max-w-3xl text-fluid-base leading-8 text-[#667085]">
